...
public class FilterVideoListApi {
    public static final String API_TAG = FilterVideoListApi.class.getSimpleName();
    ...
    public FilterVideoListApi(FragmentActivity mContext, String keyword, String limit, String skip){
    ...
    public void getFilterVideoListApi(NetworkCallResponse networkCallResponse, ResponseVideoList responseVideoList){
        ...
        service.getFilteredVideoList(keyword, limit, skip, new Callback<Response>() {
            @Override
