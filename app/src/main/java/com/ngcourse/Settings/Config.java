...
public class Config {
    public static final String BASE_URL = "http://3274eb73.ngrok.io";
    ...
    public static final String GET_COURSE_LIST_URL = "/api/v1/userapi/Course";
    public static final String GET_COURSE_VIDEO_LIST = "/api/v1/userapi/AllVideoFromCourse";
