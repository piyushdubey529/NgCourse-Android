...
public class MongodbVideoListAdapter extends RecyclerView.Adapter<MongodbVideoListAdapter.MongodbVideoListAdapterHolder> {
    private FragmentActivity context;
    public ArrayList<Video> videoList;

   public MongodbVideoListAdapter(FragmentActivity context, ArrayList<Video> videoList){
       this.context = context;
       this.videoList = videoList;
   }

    @Override
    public MongodbVideoListAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_horizontal_videolist, parent, false);
        return new MongodbVideoListAdapterHolder(view);
    }

    @Override
    public void onBindViewHolder(MongodbVideoListAdapterHolder holder, final int position) {
    ...
    public class MongodbVideoListAdapterHolder extends RecyclerView.ViewHolder{
        private ImageView thumbNail;
        private TextView videoName;
        private LinearLayout linearLayout;

        public MongodbVideoListAdapterHolder(View itemView) {
            super(itemView);
