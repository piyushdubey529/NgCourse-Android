...
public class AndroidVideoListAdapter extends RecyclerView.Adapter<AndroidVideoListAdapter.AndroidVideoListAdapterHolder> {
    private FragmentActivity context;
    public ArrayList<Video> videoList;

    public AndroidVideoListAdapter(FragmentActivity mContext, ArrayList<Video> videoList){
        this.context = mContext;
        this.videoList = videoList;
    }

    @Override
    public AndroidVideoListAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_horizontal_videolist, parent, false);
        return new AndroidVideoListAdapterHolder(view);
    }

    @Override
    public void onBindViewHolder(AndroidVideoListAdapterHolder holder, final int position) {
    ...
    public class AndroidVideoListAdapterHolder extends RecyclerView.ViewHolder{
        private ImageView thumbNail;
        private TextView videoName;
        private LinearLayout linearLayout;

        public AndroidVideoListAdapterHolder(View itemView) {
            super(itemView);
