...
public class NodeJsVideoListAdapter extends RecyclerView.Adapter<NodeJsVideoListAdapter.NodeJsVideoListAdapterHolder>{
    private FragmentActivity context;
    public ArrayList<Video> videoList;

    public NodeJsVideoListAdapter(FragmentActivity mContext, ArrayList<Video> videoList){
        this.context = mContext;
        this.videoList = videoList;
    }

    @Override
    public NodeJsVideoListAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_home_video_list, parent, false);
        return new NodeJsVideoListAdapterHolder(view);
    }

    @Override
    public void onBindViewHolder(NodeJsVideoListAdapterHolder holder, final int position) {
    ...
    public class NodeJsVideoListAdapterHolder extends RecyclerView.ViewHolder{
        private ImageView thumbNail;
        private TextView videoName;
        private LinearLayout linearLayout;

        public NodeJsVideoListAdapterHolder(View itemView) {
            super(itemView);
